...
this.on('update', function() {
  ...
  if (!this.visCells) {
    return this.visCells = calcVisible(this.rows, this.gridbody[0], this.rowHeight);
  } else {
    return this.visCells = reCalc(this.visCells, this.rows, this.gridbody[0], this.rowHeight);
  }
});
