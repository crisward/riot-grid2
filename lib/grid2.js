...
this.disableInteraction = (function(_this) {
  return function(e) {
    e.preventDefault();
    return _this.scrollAreaEvents = "auto";
  };
})(this);
...
this.scrolling = (function(_this) {
  return function(e) {
    ...
    _this.scrollWait = setTimeout(function() {
      console.log('none');
