...
riot.tag2('grid2', '<div riot-style="height:{opts.height}px" class="gridwrap"> <div onscroll="{scrolling}" riot-style="overflow:auto;left:{fixedLeftWidth}px;top:{rowHeight}px;bottom:0px" class="gridbody"> <div riot-style="width:{scrollWidth-fixedLeftWidth}px;height:{scrollHeight-rowHeight}px" class="scrollArea"> <div each="{visCells.main}" riot-style="top:{top}px;left:{left}px;width:{width}px;height:{rowHeight}px;" class="cell">{text}</div> </div> </div> <div riot-style="height:{rowHeight}px" class="gridbody"> <div riot-style="top:0px;left:{0-gridbody.scrollLeft}px;width:{scrollWidth}px;height:{rowHeight}px" class="header"> <div each="{headers.main}" riot-style="top:0px;left:{left}px;width:{width}px;height:{rowHeight}px;" class="headercell">{text}</div> </div> </div> <div riot-style="width:{fixedLeftWidth}px;height:{opts.height-2}px" class="gridbody"> <div riot-style="left:0px;top:{0-gridbody.scrollTop}px;width:{fixedLeftWidth}px;bottom:1px;z-index:2;" class="fixedLeft"> <div riot-style="top:{gridbody.scrollTop}px;left:0px;width:{fixedLeftWidth}px;height:{rowHeight}px" class="header"> <div each="{headers.fixed}" riot-style="top:0px;left:{left}px;width:{width}px;height:{rowHeight}px;" class="headercell">{text}</div> </div> <div each="{visCells.fixed}" riot-style="top:{top}px;left:{left}px;width:{width}px;height:{rowHeight}px;" class="cell">{text} </div> </div> </div> </div>', 'grid2 { display: block; } grid2 .gridwrap { position: relative; display: block; border: 1px solid #ccc; font-family: sans-serif; font-size: 14px; } grid2 .gridbody { position: absolute; overflow: hidden; top: 0; left: 0; right: 0; bottom: 0; } grid2 .fixedLeft { position: absolute; top: 0; bottom: 0; } grid2 .cell, grid2 .headercell { position: absolute; padding: 5px; whitespace: no-wrap; overflow: hidden; background: #fff; border: 1px solid #ccc; border-width: 0 1px 1px 0; } grid2 .header { position: absolute; z-index: 1; }', '', function(opts) {
var calcVisible;
...
this.on('update', function() {
  ...
  return this.visCells = calcVisible(this.rows, this.gridbody, this.rowHeight);
});
