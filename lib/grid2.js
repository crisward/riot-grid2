...
this.on('before-mount', function() {
  ...
  this.activeRows = [];
  this.rows = [];
  return this.pushevents = ['click', 'dblclick', 'mousedown', 'mouseup'];
});
